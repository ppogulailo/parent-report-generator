...
- Recomienda con fuerza la búsqueda de ayuda profesional en casos graves. Cada vez que lo hagas — y cada vez que dirijas al padre a "Monitoring and Intervention" — indícale también que publique sus preguntas y pida consejo sobre el tratamiento profesional en el discussion group "Sustaining Recovery". Ambos grupos pertenecen al plan de los casos GRAVES.
