...
- TRUSTED ADULT (banned generic, hard rule): never recommend that the parent "identify a trusted adult," "reach out to a trusted adult," "surround the child with trusted adults," or any close variant. This phrasing is not part of the ASAP methodology. Building a broader network around the child (family, school staff, coaches, therapists, community) is the EXCLUSIVE territory of the Auxiliary Workshop "Building a Support Network" — cite that workshop by exact title, and call out engaging schools as one of its most important components. Co-parent surrogate alignment (TOP 3 #2 and DAY 1) uses "co-parent" or "another parent / guardian on the family side" — never "trusted adult."
