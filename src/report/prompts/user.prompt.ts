...
- For SERIOUS reports, the primary support recommendation is the "Monitoring and Intervention discussion group". Every time you name it, pair it in the same bullet/paragraph with the "Sustaining Recovery discussion group" — the place for QUESTIONS AND PERSPECTIVES related to professional help (not where recommendations come from). And every time the "Sustaining Recovery discussion group" is referenced, immediately follow it with this exact sentence verbatim: "In Admin Spaces you can find a listing of treatment providers & therapists who endorse and support the ASAP program."
...
- En reportes GRAVES la recomendación primaria es el "Monitoring and Intervention discussion group". Cada vez que lo nombres, emparéjalo en la misma viñeta/párrafo con el "Sustaining Recovery discussion group" — el lugar para PREGUNTAS Y PERSPECTIVAS sobre la ayuda profesional (no donde se reciben las recomendaciones mismas). Y cada vez que aparezca el "Sustaining Recovery discussion group", inclúyele inmediatamente después esta oración exacta y textual EN INGLÉS: "In Admin Spaces you can find a listing of treatment providers & therapists who endorse and support the ASAP program."
...
function classifySeverityEn(
  ...
  if (tier === 'SERIOUS') {
    return {
      level: 'SERIOUS',
      guidance:
        'Inputs show multiple strong concerns or elevated safety signals. Grounded urgency — calm, direction-giving, never alarmist. Name the emotional weight directly only where the inputs actually show it. ASAP-endorsed professional referral may appear in the FIRST 72 HOURS PLAN. Reference external emergency resources only if acute-risk signals are explicit (suspected fentanyl/heroin, safety crisis, suicidality). Primary support recommendation is the "Monitoring and Intervention discussion group" (NOT "Parent Support Forum discussion group"). Use action language: "join the" or "reach out to". HARD RULE 1: every single time you write "Monitoring and Intervention discussion group" anywhere in the plan, pair it in the same bullet/paragraph with the "Sustaining Recovery discussion group" — framed as the place for QUESTIONS AND PERSPECTIVES related to professional help (not where recommendations come from). HARD RULE 2: every single time you reference the "Sustaining Recovery discussion group" anywhere, immediately follow it with this exact sentence verbatim: "In Admin Spaces you can find a listing of treatment providers & therapists who endorse and support the ASAP program." HARD RULE 3: every single time you write "therapist," "treatment provider," "professional help," "ASAP-endorsed," or refer to bringing in a clinician, the same sentence must include the words "Admin Space" (e.g., "an ASAP-endorsed therapist — find one in the Admin Space"). No exceptions. HARD RULE 4 (severity gating): do NOT cite the Auxiliary Workshop "Early Warning Signs – Identifying Substance Use Before It Becomes a Problem" anywhere — the parent is past that stage. Use "Intervening When Substance Use is Present: First Steps and Next Steps" instead. Do NOT use awareness-stage framing ("something may be developing," "early signs to watch for," "this is a good time to pay closer attention"). HARD RULE 5 (intervention depth): assume the teen will deny, deflect, shut down, or escalate. Banned soft fallbacks as a *next step*: "revisit later," "come back to it later," "wait and see," "see how it goes," "give it some time," "step back from the conversation entirely," "circle back when things calm down." (Stepping away mid-flare to regulate is allowed; "revisit later" as a recommendation is not.) DAY 3 must spell out firm responses to denial / shutdown / escalation — the boundary already aligned with the co-parent stands. DAYS 4 TO 7 must include at least one firm structured next step: a drug test (cite the Auxiliary Workshop "Drug Testing" or Article of Action "Drug Testing: A Crucial Step in Intervention"), a behavioral contract (cite "Behavioral Contracts – A Tool for Positive Change" or "Behavior Contracts: A Tool for Accountability and Growth"), or escalation to an ASAP-endorsed therapist (with "Admin Space" in the same sentence). Each KEY PRIORITIES area ends with: "if [behavior] happens this week, the next step is [specific action]." HARD RULE 6 (resource routing): peer pressure → cite Auxiliary Workshop "Understanding and Navigating Peer Pressure" + Article of Action "Peer Pressure and Social Contagion: Guiding Your Child Through Influence" — NOT a discussion group as the substitute. Confirmed/suspected use → cite "Intervening When Substance Use is Present: First Steps and Next Steps". Secrecy → "How and When to Search a Room" + "Searching Your Child’s Room – Knowing What’s in Your House". Mood swings / withdrawal / mental-health signals → "Managing Stress and Pressure – Helping Your Teen Develop Healthy Coping Skills" + "Mental Health and Drug Use – The Link Between Mental Health and Substance Abuse". Inconsistent consequences → "Behavioral Contracts – A Tool for Positive Change" + "Setting Boundaries with Respect: Discipline Without Punishment".',
    };
  }
  if (tier === 'MILD') {
    return {
...
function classifySeverityEs(
  ...
  if (tier === 'SERIOUS') {
    return {
      level: 'GRAVE',
      guidance:
        'Los inputs muestran múltiples preocupaciones fuertes o señales de seguridad elevadas. Urgencia con los pies en la tierra — calmada, orientada a la acción, nunca alarmista. Nombra el peso emocional solo donde los inputs lo muestren. Una derivación profesional ASAP-endorsed puede aparecer en el PLAN DE LAS PRIMERAS 72 HORAS. Referencia recursos externos de emergencia solo si hay señales explícitas de riesgo agudo (sospecha de fentanilo/heroína, crisis de seguridad, ideación suicida). La recomendación primaria de apoyo es el "Monitoring and Intervention discussion group" (NO el "Parent Support Forum discussion group"). Usa lenguaje de acción: "únete al" o "acércate al". REGLA DURA 1: cada vez que escribas "Monitoring and Intervention discussion group" en cualquier parte del plan, emparéjalo en la misma viñeta/párrafo con el "Sustaining Recovery discussion group" — enmarcado como el lugar para PREGUNTAS Y PERSPECTIVAS sobre la ayuda profesional (no donde se reciben las recomendaciones mismas). REGLA DURA 2: cada vez que aparezca "Sustaining Recovery discussion group" en cualquier parte, inclúyele inmediatamente después esta oración exacta y textual EN INGLÉS: "In Admin Spaces you can find a listing of treatment providers & therapists who endorse and support the ASAP program." REGLA DURA 3: cada vez que escribas "terapeuta", "proveedor de tratamiento", "ayuda profesional", "ASAP-endorsed", o te refieras a traer a un clínico, la misma oración debe incluir las palabras "Admin Space". Sin excepciones. REGLA DURA 4 (gating de severidad): NO cites el Auxiliary Workshop "Early Warning Signs – Identifying Substance Use Before It Becomes a Problem" en ninguna parte — el padre ya pasó esa etapa. Usa "Intervening When Substance Use is Present: First Steps and Next Steps" en su lugar. NO uses encuadre de etapa de conciencia ("algo puede estar empezando", "señales tempranas para vigilar", "es buen momento para estar más atento"). REGLA DURA 5 (profundidad de intervención): asume que el adolescente va a negar, esquivar, cerrarse o escalar. Fallbacks blandos prohibidos como *próximo paso*: "lo retomamos después", "vuelve más adelante", "espera y observa", "a ver cómo va", "dale tiempo", "alejarse de la conversación por completo", "vuelve cuando las cosas se calmen". (Salir un momento para regularse está permitido; "lo retomamos después" como recomendación no.) DÍA 3 debe incluir respuestas firmes a la negación / cierre / escalada — el límite ya alineado con el co-padre se mantiene. DÍAS 4 A 7 debe incluir al menos un próximo paso firme y estructurado: una prueba de drogas (citando "Drug Testing" o "Drug Testing: A Crucial Step in Intervention"), un behavioral contract (citando "Behavioral Contracts – A Tool for Positive Change" o "Behavior Contracts: A Tool for Accountability and Growth"), o escalación a un terapeuta ASAP-endorsed (con "Admin Space" en la misma oración). Cada área de PRIORIDADES CLAVE termina con: "si [comportamiento] sucede esta semana, el próximo paso es [acción específica]". REGLA DURA 6 (enrutamiento de recursos): presión de pares → cita Auxiliary Workshop "Understanding and Navigating Peer Pressure" + Article of Action "Peer Pressure and Social Contagion: Guiding Your Child Through Influence" — NO un discussion group como sustituto. Consumo confirmado/sospechado → "Intervening When Substance Use is Present: First Steps and Next Steps". Secretismo → "How and When to Search a Room" + "Searching Your Child’s Room – Knowing What’s in Your House". Cambios de ánimo / aislamiento / señales de salud mental → "Managing Stress and Pressure – Helping Your Teen Develop Healthy Coping Skills" + "Mental Health and Drug Use – The Link Between Mental Health and Substance Abuse". Consecuencias inconsistentes → "Behavioral Contracts – A Tool for Positive Change" + "Setting Boundaries with Respect: Discipline Without Punishment".',
    };
  }
  if (tier === 'MILD') {
    return {
  ...
  return {
    level: 'MODERADO',
    guidance:
      'Los inputs muestran señales reales pero no agudas. Tono firme, directo, pragmático — reconoce las preocupaciones sin amplificarlas. Los ASAP Discussion Groups y los Auxiliary Workshops son los recursos primarios. La derivación profesional se ubica en DÍAS 4 A 7 como "si estos patrones continúan o se intensifican, ese es el momento de que un terapeuta ASAP-endorsed sea el próximo paso" — no como acción inmediata de los Días 1–3. PROFUNDIDAD DE INTERVENCIÓN (regla dura): anticipa resistencia incluso en MODERADO. El DÍA 3 debe nombrar al menos un fallback concreto para la reacción predecible (negación, defensiva, cierre) — replantear el límite ya alineado con el co-padre, no volver a discutir el punto. DÍAS 4 A 7 debe nombrar al menos un próximo paso estructurado — un Auxiliary Workshop por título exacto, un Article of Action por título exacto, O participación activa en un Discussion Group específico con una cadencia de seguimiento definida. MODERADO NO requiere prueba de drogas, behavioral contract ni derivación a terapeuta ASAP-endorsed (esos son registro GRAVE), pero SÍ debe nombrar un compromiso concreto — no "a ver cómo va" ni "observa y vuelve a evaluar". Cada área de PRIORIDADES CLAVE termina con: "si [comportamiento específico] continúa esta semana, el próximo paso es [un workshop / article / discussion group / seguimiento programado nombrado]".',
  };
}
...
function computeSeverityTier(
  ...
  const safetyFours = (responses ?? []).filter(
    (v, i) => v === 4 && (SAFETY_QUESTION_INDICES as readonly number[]).includes(i),
  ).length;
