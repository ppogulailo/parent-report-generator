...
- The "Building a Support Network discussion group" is RESTRICTED — it appears only in the same paragraph as the Auxiliary Workshop "Building a Support Network." Do not cite it in BUILD THE SUPPORT GROUP or elsewhere.
...
- PROFESSIONAL HELP SEQUENCE (regla dura, cada nivel): cada vez que menciones "terapeuta", "proveedor de tratamiento", "centro de tratamiento", "ayuda profesional", "ASAP-endorsed", "clínico", "traer a un profesional", "encuentra un terapeuta" o "programa de tratamiento", el mismo párrafo debe contener esta secuencia de dos oraciones textualmente y EN INGLÉS, en este orden: \'For deeper insights, reach out to the "Sustaining Recovery discussion group."\' luego \'In Admin Spaces, under Treatment Providers, you can find a listing of treatment providers & therapists who endorse and support the ASAP program.\' Ambas oraciones. Sin excepciones. Entradas prohibidas: "If you have questions", "If you want to share experiences", "Si tienes preguntas o quieres compartir experiencias". El "Sustaining Recovery discussion group" es específicamente el foro de perspectivas sobre la ayuda profesional.
...
- El "Building a Support Network discussion group" está RESTRINGIDO — aparece solo en el mismo párrafo que el Auxiliary Workshop "Building a Support Network". No lo cites en CONSTRUIR EL GRUPO DE APOYO ni en otro lugar.
