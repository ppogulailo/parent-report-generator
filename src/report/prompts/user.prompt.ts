...
- WORKSHOP CATEGORIES (regla dura, cada cita): cita Essential Workshops como 'Essential Workshop "X"' (5 en total: "Creating Your Personalized Prevention Plan", "Effective Communication: Building Trust and Engagement with Your Teen", "Monitoring and Intervention: Knowing When and How to Step In", "Building a Support Network", "Sustaining Recovery: Parental Oversight and Support for Adolescents Post-Treatment") y Auxiliary Workshops como 'Auxiliary Workshop "X"' (20 en total — ver el directorio). "Building a Support Network" es ESSENTIAL, nunca Auxiliary — citarlo como Auxiliary es un error de etiquetado. "Creating a Healthy Home Environment – The Power of Structure and Routine" es AUXILIARY, nunca Essential — empieza con "Creating" igual que el Essential Workshop "Creating Your Personalized Prevention Plan" pero es un workshop distinto, de categoría Auxiliary; citarlo como Essential es un error de etiquetado.
