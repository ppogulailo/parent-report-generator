...
- Strongly encourage seeking professional help in serious cases. Whenever you do — and whenever you direct the parent to "Monitoring and Intervention" — also instruct the parent to post questions and ask for advice about professional treatment in the "Sustaining Recovery" discussion group. Both groups belong in the plan for SERIOUS cases.
