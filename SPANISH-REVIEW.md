...
El nivel de intervención siempre debe corresponder al nivel de riesgo. Intervenir demasiado puede ser tan contraproducente como intervenir demasiado poco. A medida que aumentan las preocupaciones, también debe aumentar el nivel de respuesta; a medida que disminuye el riesgo, la respuesta puede ajustarse en consecuencia. El objetivo no es utilizar la intervención más fuerte disponible, sino el nivel de intervención que mejor corresponda a lo que realmente está sucediendo con tu hijo.
...
Cuidarte no es un lujo, es una necesidad. Ya sea que necesites un momento de tranquilidad, hacer ejercicio o el apoyo de un consejero, haz espacio para aquello que te ayude a mantenerte centrado. Cuando te cuidas, estás en mejores condiciones de mantenerte fuerte, presente y saludable para ti y para tu familia.
...
| priority "healthy-home-environment" — intent | A day with little routine, or a home the parent is not confident discourages use, leaves rules and consequences nothing to attach to. Rebuilding predictable structure — sleep, school, meals, a home where substances are simply not available — is not cosmetic; it is the frame that makes every boundary in this plan enforceable. | Cuando hay poca rutina diaria, o el ambiente del hogar no desalienta claramente el consumo, las reglas y las consecuencias pierden la estructura que necesitan para ser efectivas. Reconstruir una estructura predecible — sueño, escuela, comidas, un hogar donde las sustancias simplemente no estén disponibles — no es cosmético; es el marco que hace aplicable cada límite de este plan. |
...
| priority "parent-support-and-exhaustion" — title | You cannot do this on empty | No puedes afrontar esto si estás agotado |
| priority "parent-support-and-exhaustion" — intent | Exhaustion, fear and isolation do some of the talking in a conversation with a child, whether or not the parent intends it. Peer support is not a comfort measure here; it is what keeps the plan executable. | El agotamiento, el miedo y el aislamiento influyen en una conversación con tu hijo, aunque no sea tu intención. El apoyo entre pares no es un consuelo aquí; es lo que mantiene el plan ejecutable. |
...
| section "encouragement" — instruction | Grounded encouragement tied to something this parent actually did or reported — never generic reassurance. Reinforce that the child is not the opponent; the substance is. Reinforce that the ASAP discussion groups are a real source of support and shared experience. Reinforce that they and their child are on the same side of this. | Ofrece un mensaje de aliento realista, basado en algo que este padre realmente hizo o reportó — nunca consuelo genérico. Refuerza que el hijo no es el oponente; la sustancia lo es. Refuerza que los ASAP discussion groups son una fuente real de apoyo y experiencia compartida. Refuerza que él y su hijo están del mismo lado de esto. |
...
| q17 — option 4 | Near-daily — running on empty | Casi a diario — completamente agotado |
